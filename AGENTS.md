...
> Kept byte-identical to `CLAUDE.md`. If you edit one, copy it to the other —
> they drifted apart before (AGENTS.md still claimed fd4 content was
> unsandboxed long after the sandbox shipped).
