export const ICON_TEMPLATES = {
  ...
  bell:
    '<path d="M8 17h8"/><path d="M9 17V11a3 3 0 1 1 6 0v6"/><path d="M6 17h12"/><path d="M10.5 20a1.5 1.5 0 0 0 3 0"/>',
  ...
  hammer: '<path d="m14 5 5 5"/><path d="m11 8 3-3 5 5-3 3"/><path d="M4 20 13 11"/>',
  key:
    '<circle cx="8" cy="12" r="3"/><path d="M11 12h9"/><path d="M17 12v3"/><path d="M20 12v2"/>',
  ...
  memory: '<rect x="4" y="7" width="16" height="10" rx="2"/><path d="M8 10h8M8 14h5"/>',
  moon:
    '<path d="M16.5 15.5A6.5 6.5 0 0 1 8.5 7.5a6.5 6.5 0 1 0 8 8Z"/>',
  network:
  ...
  pane:
    '<rect x="4.5" y="6" width="15" height="12" rx="1.5"/><path d="M12 6v12"/>',
  ...
  search:
    '<circle cx="11" cy="11" r="6"/><path d="m16 16 4.5 4.5"/>',
  server:
  ...
  wrench: '<path d="m14 7 3-3a3 3 0 0 1-4 4l-7 7a2 2 0 1 1-3-3l7-7a3 3 0 0 1 4 4Z"/>',
  workspace:
